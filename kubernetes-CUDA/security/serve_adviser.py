...
def handler_factory(server: AdviserServer) -> type[BaseHTTPRequestHandler]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="OpenAI-compatible released adviser server")
    ...
    parser.add_argument("--model-name", default="security-adviser-c")
