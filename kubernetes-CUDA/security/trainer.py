...
def train(config_path: Path) -> None:
    ...
    dataset = SecuritySFTDataset(records, tokenizer, int(training["sequence_length"]))
    ...
    trainer = Trainer(
        ...
        data_collator=SecurityDataCollator(tokenizer.pad_token_id),
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Offline eight-GPU security adviser LoRA trainer")
